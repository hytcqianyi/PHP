      ...
      if(res!="fail"){
        ...
        $.each(objs,function(){//开始判断
           if(this.msgSender == $("#chatdiv").attr("curid")){
               var chathtmlA ='';
                  chathtmlA +=' <div class="onetalkbox">';
                  chathtmlA +='   <div class="headImage"><img src=" '+this.userHeadImage+' " class="headImage"  /></div>';
                  chathtmlA +='   <div class="talknameA">'+ this.userNickname +'</div>';
                  chathtmlA +='   <div class="onetalk">'+this.msgContent+'</div>';
                  chathtmlA +=' </div>';

    ...
    <div id="friendList">
      <ul id="onlinefriendslist">
       <?php
         ...
         $res=$db->get_results("select userinfo.id,userinfo.userState,userinfo.userNickname,userinfo.userHeadImage,friendsinfo.friendNoteName from userinfo,friendsinfo where userinfo.id=friendsinfo.friendid and friendsinfo.userid=$curid");
         $onlineHtml="";
         $offlineHtml="";

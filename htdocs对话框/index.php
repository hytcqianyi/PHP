...
<body>
     ...
     <div id="personalinfo">
        <?php
           echo "<li class='mymessage'>
                       ...
                       <div class='myxinxi'>
                         <div class='mynicheng' curname='".$myname->userNickname."'>$curnicheng</div>
     ...
     <ul id="onlinefriendslist">
       <?php
         $db=new ezSQL_mysql();
         $res=$db->get_results("select userinfo.id,userinfo.userTalk,userinfo.userState,userinfo.userNickname,userinfo.userHeadImage,friendsinfo.friendNoteName from userinfo,friendsinfo where userinfo.id=friendsinfo.friendid and friendsinfo.userid=$curid");
         $onlineHtml="";
         $offlineHtml="";
         ...
         if($res)
         {
            foreach ($res as $friend) {
               ...
               //    $onlineHtml .="<li friendid='friend->id' friendNoteName='$friend->friendNoteName' class='friendli'><img src='$curHeadImageUrl' class='friHeadImage onlinePic' /><span class='friendName'>$friend->friendNoteName</span></li>";
               // }else{
